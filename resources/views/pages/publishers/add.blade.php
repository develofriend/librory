            ...
            <div class="form-container">
                ...
                <form action="{{ route('publishers.save') }}" method="post" autocomplete="off">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" id="p-email" name="email" class="form-control" required
                            value="{{ old('email') }}"
                        />
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="p-contact-number" name="contact_number" class="form-control"
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" id="p-address" name="address" class="form-control"
                            value="{{ old('address') }}"
                        />
                    </div>
